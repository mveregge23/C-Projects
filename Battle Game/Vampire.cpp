...
Vampire::Vampire(int numAttackDice, int attackDiceSides, int numDefenseDice) : Character(numAttackDice, attackDiceSides, numDefenseDice) {
	this->strength = 18;
	this->armor = 1;
	this->name = "Vampire";
}
...
int Vampire::defend() {
	...
	if (charmChance > 0.5) {
		std::cout << *this << " charmed the opponent! They can't attack!\n";
		return 32;
	}
